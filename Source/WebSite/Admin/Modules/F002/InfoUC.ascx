<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InfoUC.ascx.cs" Inherits="Admin_Modules_F002_InfoUC" %>
            ...
            <Content>
                ...
                <ext:CompositeField ID="CompositeField1" FieldLabel="Hình ảnh" LabelWidth="100" runat="server"
                    ...
                    <Items>
                        ...
                        <ext:DisplayField ID="DisplayField5" runat="server" Text="Form liên lạc" Width="100">
                        </ext:DisplayField>
                        <ext:Checkbox ID="ckbContact" runat="server" Checked="true">
                        </ext:Checkbox>
                    </Items>
                </ext:CompositeField>
