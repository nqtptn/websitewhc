<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="Admin_Modules_F002_Product" %>

<%@ Register Src="~/Admin/Modules/F002/ProductUC.ascx" TagName="ProductUC" TagPrefix="uc1" %>
...
<body>
    ...
    <uc1:ProductUC ID="ProductUC" runat="server" />
