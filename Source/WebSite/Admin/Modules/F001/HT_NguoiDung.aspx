<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HT_NguoiDung.aspx.cs" Inherits="Admin_Modules_F001_HT_NguoiDung" %>

<%@ Register Src="~/Admin/Modules/F001/HT_NguoiDungUC.ascx" TagName="HT_NguoiDungUD" TagPrefix="uc1" %>
...
<body>
        ...
        <Reader>
            <ext:JsonReader IDProperty="ID">
                <Fields>
                    ...
                    <ext:RecordField Name="IDuserlevels" />
    ...
    <uc1:HT_NguoiDungUD ID="HT_NguoiDungUD" runat="server" />
    <ext:Viewport ID="Viewport1" runat="server" Layout="border">
        <Items>
            <ext:Panel ID="Panel1" runat="server" Title="UserGroup" Region="West"
                Layout="accordion" Width="250" MinWidth="200" MaxWidth="400" Split="true" Collapsible="true">
                <Items>
            ...
            <ext:Panel ID="Panel4" runat="server" Title="Users" Region="Center"
                AutoScroll="true">
                <Items>
                    ...
                    <ext:GridPanel ID="gplList" runat="server" StoreID="stList" Title="" Height="490"
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="Username" Sortable="true" Header="Username" Width="180" />
                                <ext:Column DataIndex="FullName" Sortable="true" Header="Fullname" Width="200" />
                                <ext:Column Header="Birthday" Width="85" Sortable="true" DataIndex="BirthDate">
                                    <Renderer Fn="Ext.util.Format.dateRenderer('m/d/Y')" />
                                </ext:Column>
                                <ext:CheckColumn DataIndex="Active" Header="Đã khóa" Width="50" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
